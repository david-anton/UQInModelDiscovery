...
list_relative_selection_thressholds = [0.5]  # [1.0]
num_samples_posterior = 4096


output_directory = f"{current_date}_{input_directory}_threshold_mae_0.5_normalizingflow_lrdecay_layernormalization"
