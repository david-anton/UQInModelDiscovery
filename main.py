...
output_directory = f"{current_date}_{input_directory}_threshold_mae_0.5_normalizingflow_lrdecay9_nflayers16_noise5e-2_largermodel_moreogden_AdamW_moreiters"
