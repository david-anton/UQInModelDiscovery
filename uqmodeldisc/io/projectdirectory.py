...
class ProjectDirectory:
    ...
    def check_if_file_exists(
        self,
        file_name: str,
        search_in_output_dir: bool,
        subdir_name: Optional[str] = None,
    ) -> bool:
        if search_in_output_dir:
            path = self.create_output_file_path(file_name, subdir_name)
        else:
            path = self.create_input_file_path(file_name, subdir_name)
