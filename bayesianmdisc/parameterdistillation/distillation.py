...
#         splitted_output_masks = torch.chunk(output_mask, func_dims)
#         return [int(torch.sum(mask).item()) for mask in splitted_output_masks]
...
#         device=device,
#     )
#     lipschitz_func = IndependentLipschitzFunctions(
...
#         optimizer_distribution, lr_decay_rate_distribution
#     )
#     lr_scheduler_lipschitz = _create_lr_scheduler(
